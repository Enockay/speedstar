...
const AboutUs: React.FC = () => {
  return (
    <div className="w-full mt-7 bg-gray-50 py-16 px-4 lg:px-24">
      {/* Section 1: Our Journey */}
      <section className="mb-16">
        <h4 className="text-xl lg:text-2xl  animate-bounce font-extrabold text-center text-green-900 mb-4 tracking-wide animate-fadeIn">
          Our Journey
        </h4>
        <div className="max-w-6xl mx-auto  shadow-lg md:p-8 p-4 rounded-lg text-gray-700 leading-relaxed">
          <p className="mb-8">
            <span className="font-semibold text-green-800 animate-pulse ">Speedstar Delivery Services</span> began as a humble errand solution in Chuka, born from a passion to provide fast, reliable, and trustworthy delivery services to the local community. Our founders saw the need for a seamless connection between vendors and consumers, and that’s how Speedstar came to life—bridging the gap by delivering happiness, one package at a time.
          </p>
          <p className="mb-8">
      ...
      <section className="mb-16">
        <h3 className="text-xl lg:text-xl font-extrabold text-center text-gray-800 mb-12 animate-fadeIn">
          Shaping the Future
        </h3>
        <div className="max-w-6xl mx-auto  text-gray-700 leading-relaxed">
          <p className="mb-8">
      ...
      <section className="md:mb-16 mb-8 bg-green-50 py-10 rounded-xl shadow-md p-8">
        <h3 className="text-xl lg:text-xl font-extrabold text-center text-green-900 mb-8 animate-fadeIn">
          Why We Deliver
        </h3>
